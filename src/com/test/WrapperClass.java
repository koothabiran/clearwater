...
public class WrapperClass {
	...
	public void launchBroswer(String Browser, String URL) {
		if (Browser.equalsIgnoreCase("firefox")) {
			...
			profile.setPreference("browser.helperApps.neverAsk.openFile", "application/msword, application/x-unknown, text/comma-separated-values, application/excel, application/vnd.ms-excel, application/vnd.msexcel, text/anytext, application/pdf, application/csv, text/csv, image/png , image/jpeg, text/html, text/plain, application/octet-stream");
			profile.setPreference("browser.helperApps.neverAsk.saveToDisk", "application/msword, application/x-unknown, text/comma-separated-values, application/excel, application/vnd.ms-excel, application/vnd.msexcel, text/anytext, application/pdf, application/csv, text/csv, image/png , image/jpeg, text/html, text/plain, application/octet-stream");
			//profile.setPreference("browser.helperApps.neverAsk.saveToDisk", "text/x-csv,application/x-csv,text/x-comma-separated-values,text/comma-separated-values,application/csv,text/csv,application/x-msexcel,application/excel,application/x-excel,application/vnd.ms-excel,image/png,image/jpeg,text/html,text/plain,application/msword,application/xml,application/pdf");
...
//					expType.printStackTrace();
	...
	public String[][] getlogin() throws IOException {
		// Create an input stream
		FileInputStream fis = new FileInputStream(new File(".\\Testdata\\Book1.xlsx"));
